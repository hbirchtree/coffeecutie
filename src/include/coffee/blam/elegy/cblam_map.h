...
static cstring const blam_header_head =
    "head"; /*!< Character string for header of file header, used to determine
               validity of data*/
static cstring const blam_header_foot =
    "foot"; /*!< Character string for footer of file header, used to determine
               validity of data*/

/*!
 * \brief A mockup of the Halo 3 file header format, only speculation out of hex
 * editor
 */
