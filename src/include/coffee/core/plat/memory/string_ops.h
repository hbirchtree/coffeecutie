...
template<bool CaseInsensitive, bool NoIndex>
...
template<
    class CompMode,
    class TargetMode,
    typename std::enable_if<CompMode::no_index == TargetMode::no_index>::type* =
        nullptr,
    typename std::enable_if<
        CompMode::ignore_case == TargetMode::ignore_case>::type* = nullptr>
struct comparison_of_type
{
    typedef CompMode type;
};
...
template<
    typename CompMode,
    typename CharType,
    typename comparison_of_type<CompMode, comp_idx>::type* = nullptr,
    typename char_of_type<CharType, char>::type*           = nullptr>
...
template<
    typename CompMode,
    typename CharType,
    typename comparison_of_type<CompMode, comp_default>::type* = nullptr,
    typename char_of_type<CharType, char>::type*               = nullptr>
...
template<
    typename CompMode,
    typename CharType,
    typename comparison_of_type<CompMode, comp_nocase>::type* = nullptr,
    typename char_of_type<CharType, char>::type*              = nullptr>
FORCEDINLINE bool cmp(const CharType* s1, const CharType* s2)
{
    return C_CASECMP(s1, s2) == 0;
}
...
FORCEDINLINE bool cmp(const CharType* s1, const CharType* s2)
{
    return C_WCASECMP(s1, s2) == 0;
}

template<
    typename CompMode,
    typename CharType,
    typename comparison_of_type<CompMode, comp_nocase_idx>::type* = nullptr,
    typename char_of_type<CharType, char>::type*                  = nullptr>
FORCEDINLINE size_t cmp(const CharType* s1, const CharType* s2)
{
