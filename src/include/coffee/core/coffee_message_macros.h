 ...
 * \param name
 */
C_DEPRECATED FORCEDINLINE void C_STUBBED(cstring name)
{
#ifndef NDEBUG
...
C_DEPRECATED FORCEDINLINE void C_FIXME(cstring identifier)
{
#ifndef NDEBUG
...
C_DEPRECATED FORCEDINLINE void C_PERFWARN(cstring file, int line, cstring msg)
{
#ifndef NDEBUG
 ...
 * \param name
 */
C_DEPRECATED FORCEDINLINE void C_BADERROR(cstring name)
{
#ifndef NDEBUG
