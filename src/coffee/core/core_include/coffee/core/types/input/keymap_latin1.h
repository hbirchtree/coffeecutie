 ...
 *  embedded devices suffer with SDL2, but work well with a lighter
 * implementation. This mapping is just a common ground. Further keys are found
 * in "cinput_keymap.h"
 */
