...
#include "keymap_latin1.h"

namespace Coffee {
namespace Input {

/*!
 * \brief Xbox 360 controller mapping of buttons. Same layout as SDL2's
 * GameController, but we do not expose all parts of SDL2.
 */
enum CIControllerButtonMapping : u16
{
    CK_BUTTON_BASE  = 0x200,
...
/*!
 * \brief Xbox 360 controller mapping of axes. Same mapping as SDL2's
 * GameController.
 */
enum CIControllerAxisMapping : u16
{
    CK_AXIS_BASE          = 0x210,
...
C_FLAGS(CISpecialKeyMapping, u16);
C_FLAGS(CIControllerAxisMapping, u16);
C_FLAGS(CIControllerButtonMapping, u16);
