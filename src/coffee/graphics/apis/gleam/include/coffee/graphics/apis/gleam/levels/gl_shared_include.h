 ...
 *  - Header-defined functions + linked functions (Maemo, Android, NaCL,
 * Emscripten)
 *  - Dynamically loaded functions from the OS (Android, Linux, Mac OSX,
 * Windows)
 *
 ...
 *
 * Android can do both, but we use dynamic loading to avoid separate GLESv2 and
 * GLESv3 loading.
 *
