...
constexpr u32 texture_green_size     = 0x805D;
constexpr u32 texture_blue_size      = 0x805E;
constexpr u32 texture_alpha_size     = 0x805F;
constexpr u32 texture_luminance_size = 0x8060;
constexpr u32 texture_intensity_size = 0x8061;
} // namespace values
} // namespace gl::ext::texture
