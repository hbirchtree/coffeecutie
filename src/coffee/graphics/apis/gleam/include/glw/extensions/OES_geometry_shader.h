...
namespace values {
constexpr libc_types::u32 lines_adjacency                          = 0x000A;
constexpr libc_types::u32 line_strip_adjacency                     = 0x000B;
constexpr libc_types::u32 triangles_adjacency                      = 0x000C;
constexpr libc_types::u32 triangle_strip_adjacency                 = 0x000D;
