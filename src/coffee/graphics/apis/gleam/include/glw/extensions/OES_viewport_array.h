    ...
    error_check           check_errors = error_check::on)
{
    ...
    detail::error_check("DepthRangeArrayfvOES"sv, check_errors);
}
    ...
    error_check     check_errors = error_check::on)
{
    ...
    detail::error_check("GetFloati_vOES"sv, check_errors);
}
    ...
    error_check           check_errors = error_check::on)
{
    ...
    detail::error_check("ScissorArrayvOES"sv, check_errors);
}
    ...
    error_check           check_errors = error_check::on)
{
    ...
    glViewportArrayvOES(
        ...
        count,
        v.size() ? reinterpret_cast<const GLfloat*>(v.data()) : nullptr);
    detail::error_check("ViewportArrayvOES"sv, check_errors);
}
