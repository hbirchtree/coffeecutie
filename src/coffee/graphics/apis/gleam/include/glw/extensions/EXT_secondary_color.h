...
requires(semantic::concepts::Vector<vec_3_i8, i8, 3>) STATICINLINE
    void secondary_color3b(vec_3_i8 const& red)
{
...
requires(semantic::concepts::Span<span_const_i8>&& std::is_same_v<
    ...
    void secondary_color3bv(span_const_i8 const& v)
{
    using namespace std::string_view_literals;
    if constexpr(compile_info::debug_mode)
    {
...
requires(semantic::concepts::Vector<vec_3_f64, f64, 3>) STATICINLINE
    void secondary_color3d(vec_3_f64 const& red)
{
    using namespace std::string_view_literals;
    if constexpr(compile_info::debug_mode)
    {
...
requires(semantic::concepts::Vector<vec_3_f32, f32, 3>) STATICINLINE
    void secondary_color3f(vec_3_f32 const& red)
{
    using namespace std::string_view_literals;
    if constexpr(compile_info::debug_mode)
    {
...
requires(semantic::concepts::Vector<vec_3_i32, i32, 3>) STATICINLINE
    void secondary_color3i(vec_3_i32 const& red)
{
    using namespace std::string_view_literals;
    if constexpr(compile_info::debug_mode)
    {
...
requires(semantic::concepts::Vector<vec_3_i16, i16, 3>) STATICINLINE
    void secondary_color3s(vec_3_i16 const& red)
{
    using namespace std::string_view_literals;
    if constexpr(compile_info::debug_mode)
    {
...
requires(semantic::concepts::Vector<vec_3_u8, u8, 3>) STATICINLINE
    void secondary_color3ub(vec_3_u8 const& red)
{
    using namespace std::string_view_literals;
    if constexpr(compile_info::debug_mode)
    {
...
requires(semantic::concepts::Span<span_const_u8>&& std::is_same_v<
    ...
    void secondary_color3ubv(span_const_u8 const& v)
{
    using namespace std::string_view_literals;
    if constexpr(compile_info::debug_mode)
    {
...
requires(semantic::concepts::Vector<vec_3_u32, u32, 3>) STATICINLINE
    void secondary_color3ui(vec_3_u32 const& red)
{
    using namespace std::string_view_literals;
    if constexpr(compile_info::debug_mode)
    {
...
requires(semantic::concepts::Vector<vec_3_u16, u16, 3>) STATICINLINE
    void secondary_color3us(vec_3_u16 const& red)
{
    using namespace std::string_view_literals;
    if constexpr(compile_info::debug_mode)
    {
