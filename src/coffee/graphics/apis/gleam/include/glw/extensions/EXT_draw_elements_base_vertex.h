    ...
    i32                       basevertex)
{
    ...
    glDrawElementsBaseVertexEXT(
        ...
        basevertex);
    detail::error_check("DrawElementsBaseVertexEXT"sv);
}
    ...
    i32                       basevertex)
{
    ...
    glDrawElementsInstancedBaseVertexEXT(
        ...
        instancecount,
        basevertex);
    detail::error_check("DrawElementsInstancedBaseVertexEXT"sv);
}
    ...
    i32                       basevertex)
{
    ...
    glDrawRangeElementsBaseVertexEXT(
        ...
        indices.size() ? reinterpret_cast<const void*>(indices.data())
                       : nullptr,
        basevertex);
    detail::error_check("DrawRangeElementsBaseVertexEXT"sv);
}
