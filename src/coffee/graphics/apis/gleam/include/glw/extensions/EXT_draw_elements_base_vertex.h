...
namespace gl::ext::draw_elements_base_vertex {
namespace values {
} // namespace values

/*!
 * \brief Part of GL_EXT_draw_elements_base_vertex
 * \param mode GLenum
 * \param count GLsizei
 * \param type GLenum
    ...
    error_check               check_errors = error_check::on)
{
    ...
    glDrawElementsBaseVertexEXT(
        ...
        basevertex);
    detail::error_check("DrawElementsBaseVertexEXT"sv, check_errors);
}
    ...
    error_check               check_errors = error_check::on)
{
    ...
    glDrawElementsInstancedBaseVertexEXT(
        ...
        instancecount,
        basevertex);
    detail::error_check("DrawElementsInstancedBaseVertexEXT"sv, check_errors);
}
    ...
    error_check               check_errors = error_check::on)
{
    ...
    glDrawRangeElementsBaseVertexEXT(
        ...
        indices.size() ? reinterpret_cast<const void*>(indices.data())
                       : nullptr,
        basevertex);
    detail::error_check("DrawRangeElementsBaseVertexEXT"sv, check_errors);
}
...
namespace gl::ext::draw_elements_base_vertex {
constexpr auto name = "GL_EXT_draw_elements_base_vertex";
}
