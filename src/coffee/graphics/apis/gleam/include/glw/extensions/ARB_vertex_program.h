...
constexpr libc_types::u32 program_address_registers            = 0x88B0;
constexpr libc_types::u32 max_program_address_registers        = 0x88B1;
constexpr libc_types::u32 program_native_address_registers     = 0x88B2;
constexpr libc_types::u32 max_program_native_address_registers = 0x88B3;
