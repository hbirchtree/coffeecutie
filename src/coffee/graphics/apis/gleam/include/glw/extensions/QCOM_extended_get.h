...
requires(semantic::concepts::Span<span_void>) STATICINLINE
    void ext_get_buffer_pointerv(GLenum target, span_void params)
{
...
requires(semantic::concepts::Span<span_i32>&& std::is_same_v<
    ...
    void ext_get_tex_level_parameter(
