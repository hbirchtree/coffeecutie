...
#ifdef GLW_FPTR_TRACE
    GLW_FPTR_TRACE(glBindTextureUnit, unit, texture);
#endif
...
#ifdef GLW_FPTR_TRACE
    GLW_FPTR_TRACE(glCheckNamedFramebufferStatus, framebuffer, target);
#endif
    auto out =
...
requires(
    MinimumVersion<Current, Version<4, 5>> && concepts::span<span_const_f32> &&
    std::is_same_v<
...
requires(
    MinimumVersion<Current, Version<4, 5>> && concepts::span<span_const_i32> &&
    std::is_same_v<
...
requires(
    MinimumVersion<Current, Version<4, 5>> && concepts::span<span_const_u32> &&
    std::is_same_v<
...
#ifdef GLW_FPTR_TRACE
    GLW_FPTR_TRACE(glCopyTextureSubImage1D, texture, level, xoffset, x, width);
#endif
...
#ifdef GLW_FPTR_TRACE
    GLW_FPTR_TRACE(glCopyTextureSubImage2D, texture, level, xoffset, x, width);
#endif
...
#ifdef GLW_FPTR_TRACE
    GLW_FPTR_TRACE(glCopyTextureSubImage3D, texture, level, xoffset, x, width);
#endif
...
requires(
    MinimumVersion<Current, Version<4, 5>> && concepts::span<span_u32> &&
    std::is_same_v<
...
#ifdef GLW_FPTR_TRACE_DATA
    GLW_FPTR_TRACE_DATA(glCreateBuffers, ::glw::trace::byte_span(buffers));
#endif
    glCreateBuffers(
        buffers.size(),
...
#ifdef GLW_FPTR_TRACE_DATA
    GLW_FPTR_TRACE_DATA(
        glCreateFramebuffers, ::glw::trace::byte_span(framebuffers));
#endif
...
#ifdef GLW_FPTR_TRACE_DATA
    GLW_FPTR_TRACE_DATA(
        glCreateProgramPipelines, ::glw::trace::byte_span(pipelines));
#endif
...
#ifdef GLW_FPTR_TRACE_DATA
    GLW_FPTR_TRACE_DATA(glCreateQueries, ::glw::trace::byte_span(ids), target);
#endif
    glCreateQueries(
...
#ifdef GLW_FPTR_TRACE_DATA
    GLW_FPTR_TRACE_DATA(
        glCreateRenderbuffers, ::glw::trace::byte_span(renderbuffers));
#endif
...
#ifdef GLW_FPTR_TRACE_DATA
    GLW_FPTR_TRACE_DATA(glCreateSamplers, ::glw::trace::byte_span(samplers));
#endif
    glCreateSamplers(
        samplers.size(),
...
#ifdef GLW_FPTR_TRACE_DATA
    GLW_FPTR_TRACE_DATA(
        glCreateTextures, ::glw::trace::byte_span(textures), target);
#endif
    glCreateTextures(
        static_cast<GLenum>(target),
        textures.size(),
...
#ifdef GLW_FPTR_TRACE_DATA
    GLW_FPTR_TRACE_DATA(
        glCreateTransformFeedbacks, ::glw::trace::byte_span(ids));
#endif
...
#ifdef GLW_FPTR_TRACE_DATA
    GLW_FPTR_TRACE_DATA(glCreateVertexArrays, ::glw::trace::byte_span(arrays));
#endif
...
#ifdef GLW_FPTR_TRACE
    GLW_FPTR_TRACE(glDisableVertexArrayAttrib, vaobj, index);
#endif
...
#ifdef GLW_FPTR_TRACE
    GLW_FPTR_TRACE(glEnableVertexArrayAttrib, vaobj, index);
#endif
...
#ifdef GLW_FPTR_TRACE
    GLW_FPTR_TRACE(glFlushMappedNamedBufferRange, buffer, offset, length);
#endif
...
#ifdef GLW_FPTR_TRACE
    GLW_FPTR_TRACE(glGenerateTextureMipmap, texture);
#endif
...
requires(
    MinimumVersion<Current, Version<4, 5>> && concepts::span<span_i64> &&
    std::is_same_v<
...
requires(
    MinimumVersion<Current, Version<4, 5>> && concepts::span<span_i32> &&
    std::is_same_v<
...
#ifdef GLW_FPTR_TRACE_DATA
    GLW_FPTR_TRACE_DATA(
        glGetNamedBufferSubData, ::glw::trace::byte_span(data), buffer, offset);
#endif
...
#ifdef GLW_FPTR_TRACE
    GLW_FPTR_TRACE(glGetQueryBufferObjecti64v, id, buffer, pname, offset);
#endif
...
#ifdef GLW_FPTR_TRACE
    GLW_FPTR_TRACE(glGetQueryBufferObjectiv, id, buffer, pname, offset);
#endif
...
#ifdef GLW_FPTR_TRACE
    GLW_FPTR_TRACE(glGetQueryBufferObjectui64v, id, buffer, pname, offset);
#endif
...
#ifdef GLW_FPTR_TRACE
    GLW_FPTR_TRACE(glGetQueryBufferObjectuiv, id, buffer, pname, offset);
#endif
...
requires(
    MinimumVersion<Current, Version<4, 5>> && concepts::span<span_f32> &&
    std::is_same_v<
...
#ifdef GLW_FPTR_TRACE_DATA
    GLW_FPTR_TRACE_DATA(
        glGetTransformFeedbackiv, ::glw::trace::byte_span(param), xfb, pname);
#endif
...
#ifdef GLW_FPTR_TRACE_DATA
    GLW_FPTR_TRACE_DATA(
        glGetVertexArrayiv, ::glw::trace::byte_span(param), vaobj, pname);
#endif
    glGetVertexArrayiv(
        vaobj,
        static_cast<GLenum>(pname),
...
requires(
    MinimumVersion<Current, Version<4, 5>> &&
    concepts::span<span_const_framebuffer_attachment> &&
    std::is_same_v<
...
#ifdef GLW_FPTR_TRACE
    GLW_FPTR_TRACE(glMapNamedBuffer, buffer, access);
#endif
...
#ifdef GLW_FPTR_TRACE
    GLW_FPTR_TRACE(glMapNamedBufferRange, buffer, offset, length, access);
#endif
...
#ifdef GLW_FPTR_TRACE_DATA
    GLW_FPTR_TRACE_DATA(
        glNamedBufferData, ::glw::trace::byte_span(data), buffer, usage);
#endif
    glNamedBufferData(
        buffer,
        data.size() *
...
#ifdef GLW_FPTR_TRACE_DATA
    GLW_FPTR_TRACE_DATA(
        glNamedBufferStorage, ::glw::trace::byte_span(data), buffer, flags);
#endif
...
#ifdef GLW_FPTR_TRACE_DATA
    GLW_FPTR_TRACE_DATA(
        glNamedBufferSubData, ::glw::trace::byte_span(data), buffer, offset);
#endif
...
#ifdef GLW_FPTR_TRACE
    GLW_FPTR_TRACE(glNamedFramebufferDrawBuffer, framebuffer, buf);
#endif
...
requires(
    MinimumVersion<Current, Version<4, 5>> &&
    concepts::span<span_const_color_buffer> &&
    std::is_same_v<
...
#ifdef GLW_FPTR_TRACE
    GLW_FPTR_TRACE(glNamedFramebufferParameteri, framebuffer, pname, param);
#endif
...
#ifdef GLW_FPTR_TRACE
    GLW_FPTR_TRACE(glNamedFramebufferReadBuffer, framebuffer, src);
#endif
...
#ifdef GLW_FPTR_TRACE
    GLW_FPTR_TRACE(glTextureBuffer, texture, internalformat, buffer);
#endif
...
#ifdef GLW_FPTR_TRACE_DATA
    GLW_FPTR_TRACE_DATA(
        glTextureParameterIiv, ::glw::trace::byte_span(params), texture, pname);
#endif
...
#ifdef GLW_FPTR_TRACE
    GLW_FPTR_TRACE(glTextureParameterf, texture, pname, param);
#endif
...
#ifdef GLW_FPTR_TRACE_DATA
    GLW_FPTR_TRACE_DATA(
        glTextureParameterfv, ::glw::trace::byte_span(param), texture, pname);
#endif
...
#ifdef GLW_FPTR_TRACE
    GLW_FPTR_TRACE(glTextureParameteri, texture, pname, param);
#endif
...
#ifdef GLW_FPTR_TRACE_DATA
    GLW_FPTR_TRACE_DATA(
        glTextureParameteriv, ::glw::trace::byte_span(param), texture, pname);
#endif
...
#ifdef GLW_FPTR_TRACE
    GLW_FPTR_TRACE(glTextureStorage1D, texture, levels, internalformat, width);
#endif
    glTextureStorage1D(
...
#ifdef GLW_FPTR_TRACE
    GLW_FPTR_TRACE(glTextureStorage2D, texture, levels, internalformat, width);
#endif
    glTextureStorage2D(
        texture,
        levels,
...
#ifdef GLW_FPTR_TRACE
    GLW_FPTR_TRACE(glTextureStorage3D, texture, levels, internalformat, width);
#endif
    glTextureStorage3D(
        texture,
        levels,
...
#ifdef GLW_FPTR_TRACE
    GLW_FPTR_TRACE(glTransformFeedbackBufferBase, xfb, index, buffer);
#endif
...
#ifdef GLW_FPTR_TRACE
    GLW_FPTR_TRACE(glUnmapNamedBuffer, buffer);
#endif
...
#ifdef GLW_FPTR_TRACE
    GLW_FPTR_TRACE(glVertexArrayBindingDivisor, vaobj, bindingindex, divisor);
#endif
...
#ifdef GLW_FPTR_TRACE
    GLW_FPTR_TRACE(glVertexArrayElementBuffer, vaobj, buffer);
#endif
...
#ifdef GLW_FPTR_TRACE_DATA
    GLW_FPTR_TRACE_DATA(
        glGetnCompressedTexImage, ::glw::trace::byte_span(pixels), target, lod);
#endif
...
requires(
    MinimumVersion<Current, Version<4, 5>> && concepts::span<span_f64> &&
    std::is_same_v<
...
#ifdef GLW_FPTR_TRACE_DATA
    GLW_FPTR_TRACE_DATA(
        glReadnPixels, ::glw::trace::byte_span(data), x, width, format, type);
#endif
    glReadnPixels(
        x[0],
        x[1],
