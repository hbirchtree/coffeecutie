...
enum class internal_format : u32
{
    ...
    compressed_srgb             = 0x8C48, // GL_COMPRESSED_SRGB
    ...
    compressed_srgb_alpha = 0x8C49, // GL_COMPRESSED_SRGB_ALPHA
    ...
    srgb_alpha                  = 0x8C42, // GL_SRGB_ALPHA
    ...
    depth_stencil_ext             = 0x84F9, // GL_DEPTH_STENCIL_EXT
    depth_stencil_mesa            = 0x8750, // GL_DEPTH_STENCIL_MESA
    depth_stencil_nv              = 0x84F9, // GL_DEPTH_STENCIL_NV
    depth_stencil_oes             = 0x84F9, // GL_DEPTH_STENCIL_OES
    dual_alpha12_sgis             = 0x8112, // GL_DUAL_ALPHA12_SGIS
    dual_alpha16_sgis             = 0x8113, // GL_DUAL_ALPHA16_SGIS
    dual_alpha4_sgis              = 0x8110, // GL_DUAL_ALPHA4_SGIS
    dual_alpha8_sgis              = 0x8111, // GL_DUAL_ALPHA8_SGIS
    dual_intensity12_sgis         = 0x811A, // GL_DUAL_INTENSITY12_SGIS
    dual_intensity16_sgis         = 0x811B, // GL_DUAL_INTENSITY16_SGIS
    dual_intensity4_sgis          = 0x8118, // GL_DUAL_INTENSITY4_SGIS
    dual_intensity8_sgis          = 0x8119, // GL_DUAL_INTENSITY8_SGIS
    dual_luminance12_sgis         = 0x8116, // GL_DUAL_LUMINANCE12_SGIS
    dual_luminance16_sgis         = 0x8117, // GL_DUAL_LUMINANCE16_SGIS
    dual_luminance4_sgis          = 0x8114, // GL_DUAL_LUMINANCE4_SGIS
    dual_luminance8_sgis          = 0x8115, // GL_DUAL_LUMINANCE8_SGIS
    dual_luminance_alpha4_sgis    = 0x811C, // GL_DUAL_LUMINANCE_ALPHA4_SGIS
    dual_luminance_alpha8_sgis    = 0x811D, // GL_DUAL_LUMINANCE_ALPHA8_SGIS
    ...
    quad_alpha4_sgis              = 0x811E, // GL_QUAD_ALPHA4_SGIS
    quad_alpha8_sgis              = 0x811F, // GL_QUAD_ALPHA8_SGIS
    quad_intensity4_sgis          = 0x8122, // GL_QUAD_INTENSITY4_SGIS
    quad_intensity8_sgis          = 0x8123, // GL_QUAD_INTENSITY8_SGIS
    quad_luminance4_sgis          = 0x8120, // GL_QUAD_LUMINANCE4_SGIS
    quad_luminance8_sgis          = 0x8121, // GL_QUAD_LUMINANCE8_SGIS
    ...
    sr8_ext                       = 0x8FBD, // GL_SR8_EXT
    srg8_ext                      = 0x8FBE, // GL_SRG8_EXT
    srgb8_alpha8_ext              = 0x8C43, // GL_SRGB8_ALPHA8_EXT
    srgb8_ext                     = 0x8C41, // GL_SRGB8_EXT
    srgb8_nv                      = 0x8C41, // GL_SRGB8_NV
    srgb_alpha_ext                = 0x8C42, // GL_SRGB_ALPHA_EXT
    srgb_ext                      = 0x8C40, // GL_SRGB_EXT
    ...
    stencil_index_oes             = 0x1901, // GL_STENCIL_INDEX_OES
