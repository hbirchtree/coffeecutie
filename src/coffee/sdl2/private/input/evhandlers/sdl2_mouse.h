...
FORCEDINLINE void EventHandleMouseWheel(
    SDL2EventHandler* ctxt, const SDL_MouseWheelEvent& wheel)
{
...
FORCEDINLINE void EventHandleMouseMove(
    SDL2EventHandler* ctxt, const SDL_MouseMotionEvent& motion)
{
...
FORCEDINLINE void EventHandleMouseBtn(
    SDL2EventHandler* ctxt, const SDL_MouseButtonEvent& btn)
{
