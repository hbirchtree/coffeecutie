...
FORCEDINLINE CIMouseButtonEvent::MouseButton InterpretMouseBtn(Uint8 code)
{
    switch(code)
    {
    case SDL_BUTTON_LEFT:
        return CIMouseButtonEvent::LeftButton;
    case SDL_BUTTON_MIDDLE:
        return CIMouseButtonEvent::MiddleButton;
    case SDL_BUTTON_RIGHT:
        return CIMouseButtonEvent::RightButton;
    case SDL_BUTTON_X1:
        return CIMouseButtonEvent::X1Button;
    case SDL_BUTTON_X2:
        return CIMouseButtonEvent::X2Button;

    // Any remaining buttons will map to the range 17-255
    default:
        return (CIMouseButtonEvent::MouseButton)(code + 11);
    }
}

FORCEDINLINE uint8 InterpretMouseBtnMask(Uint32 code)
{
    uint8 res = 0;
...
FORCEDINLINE CIKeyEvent::KeyModifiers InterpretKeyModifier(Uint16 mod)
{
...
FORCEDINLINE uint32 InterpretKeySymbol(SDL_Keycode key)
{
    switch(key)
    {
    case SDLK_KP_ENTER:
    ...
    case SDLK_AC_BACK:
        return CK_Android_Back;
    case SDLK_AC_SEARCH:
        return CK_Android_Menu;
