...
struct SysCPUTemp : interfaces::CPUTempProvider,
...
struct SysGPUTemp : interfaces::GPUTempProvider,
...
struct SysBattery : interfaces::BatteryProvider,
...
struct SysCPUClock : interfaces::CPUClockProvider,
