...
enum class v2 : libc_types::i16
{
    ...
    device_set_never_appears_locked = 137,
    device_get_power,
    device_set_power    = 500,
    device_set_position = 139,
    device_get_position,
    ...
    game_won = 309,
    game_lost,
    game_safe_to_save = 311,
    game_safe_to_speak,
    game_is_cooperative      = 314,
    game_save                = 315,
    game_save_no_timeout     = 317,
    game_save_totally_unsafe = 318,
    game_saving              = 319,
    game_reverted            = 321,
    ...
    player0_look_pitch_is_inverted = 444,
    player0_look_invert_pitch      = 443,
