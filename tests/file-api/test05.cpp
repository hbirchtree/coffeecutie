...
bool filewrite_large_test()
{
...

    {
        ...
        memcpy(large_data.data, test_string, libc::str::len(test_string));
        memcpy(&large_data[4_GB], test_string, libc::str::len(test_string));
    }
