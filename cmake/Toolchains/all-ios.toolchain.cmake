...
set (CMAKE_CXX_FLAGS_INIT "${CMAKE_CXX_FLAGS} -fvisibility=hidden -fvisibility-inlines-hidden")
...
set ( CMAKE_CXX_FLAGS_RELWITHDEBINFO "${CMAKE_CXX_FLAGS_RELWITHDEBINFO} -g -Os" )
set ( CMAKE_C_FLAGS_RELWITHDEBINFO "${CMAKE_C_FLAGS_RELWITHDEBINFO} -g -Os" )
...
elseif (${IOS_PLATFORM} STREQUAL "SIMULATOR")
    set ( CMAKE_LIBRARY_ARCHITECTURE "ios-simulator" CACHE STRING "" )
elseif (${IOS_PLATFORM} STREQUAL "SIMULATOR64")
    set ( CMAKE_LIBRARY_ARCHITECTURE "ios-simulator64" CACHE STRING "" )
endif (${IOS_PLATFORM} STREQUAL "OS")
