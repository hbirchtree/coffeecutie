...
# Android NDK
if(NOT ANDROID_NDK)
  set ( ANDROID_NDK "$ENV{ANDROID_NDK}" CACHE PATH "" )
else()
...
set ( CMAKE_FIND_ROOT_PATH "${CMAKE_FIND_ROOT_PATH};${COFFEE_ROOT_DIR};${NATIVE_LIBRARY_DIR};${NATIVE_LIBRARY_DIR}/${ANDROID_ABI};${CMAKE_SOURCE_DIR}/libs" )
