...
#
# Autogenerated by ./gen-findscript.sh
...
if(COFFEE_CORE_LIBRARY_TMP)
    set ( COFFEE_CORE_LIBRARY "${COFFEE_CORE_LIBRARY_TMP};${STANDARDLIBS_LIBRARIES}" CACHE STRING "" )
endif()
...
if(COFFEE_GLEAM_LIBRARY_TMP)
    set ( COFFEE_GLEAM_LIBRARY "${COFFEE_GLEAM_LIBRARY_TMP};${COFFEE_CORE_LIBRARY}" CACHE STRING "" )
endif()
...
if(COFFEE_ASIO_LIBRARY_TMP)
    set ( COFFEE_ASIO_LIBRARY "${COFFEE_ASIO_LIBRARY_TMP};${COFFEE_CORE_LIBRARY}" CACHE STRING "" )
endif()
...
if(COFFEE_OPENAL_LIBRARY_TMP)
    set ( COFFEE_OPENAL_LIBRARY "${COFFEE_OPENAL_LIBRARY_TMP};${COFFEE_CORE_LIBRARY};${OPENAL_LIBRARY}" CACHE STRING "" )
endif()
...
if(COFFEE_SDL2_LIBRARY_TMP)
    set ( COFFEE_SDL2_LIBRARY "${COFFEE_SDL2_LIBRARY_TMP};${COFFEE_CORE_LIBRARY};${SDL2_LIBRARY}" CACHE STRING "" )
endif()
...
if(COFFEE_BLAM_LIBRARY_TMP)
    set ( COFFEE_BLAM_LIBRARY "${COFFEE_BLAM_LIBRARY_TMP};${COFFEE_CORE_LIBRARY}" CACHE STRING "" )
endif()
...
if(COFFEE_GRAPHICS_LIBRARY_TMP)
    set ( COFFEE_GRAPHICS_LIBRARY "${COFFEE_GRAPHICS_LIBRARY_TMP};${COFFEE_CORE_LIBRARY}" CACHE STRING "" )
endif()
...
if(COFFEE_IMAGE_LIBRARY_TMP)
    set ( COFFEE_IMAGE_LIBRARY "${COFFEE_IMAGE_LIBRARY_TMP};${COFFEE_CORE_LIBRARY}" CACHE STRING "" )
endif()
