def linux_targets = ['ubuntu.amd64', 'steam.amd64', 'raspberry.armhf', 'maemo.armel', 'fedora.amd64', 'emscripten.wasm', 'emscripten.asmjs', 'android.armv8a.nougat.gles3', 'android.armv7a.nougat.gles2', 'android.armv7a.gingerbread.gles2', ]
