def linux_targets = ['ubuntu.amd64', 'steam.amd64', 'raspberry.armhf', 'fedora.amd64', 'emscripten.wasm', 'emscripten.asmjs', 'android.armv8a.nougat.gles3', 'android.armv7a.kitkat.gles2', ]
        ...
        job.with {
            steps {
                environmentVariables {
                    ...
                    env('DEPENDENCIES', 'hbirchtree/openal%hbirchtree/bullet%hbirchtree/shaderc%hbirchtree/assimp%hbirchtree/libav%hbirchtree/glslang%hbirchtree/openssl%hbirchtree/sdl2%hbirchtree/spirv-cross%hbirchtree/squish%')
