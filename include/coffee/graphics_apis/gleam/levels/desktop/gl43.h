...
struct CGL43 : CGL33
{
    ...
    STATICINLINE void BufInvalidateData(CGhnd h){glInvalidateBufferData(h);}
    ...
    STATICINLINE void VAOAttribIPointer(){}
    STATICINLINE void VAOAttribLPointer(){}
    ...
    /* Framebuffer */
    STATICINLINE void FBInvalidate(CGenum,size_t,const CGenum*){}
     ...
     */
    STATICINLINE void DrawArraysIndirect(Prim p,PrimCre c,uint64 off)
     ...
     */
    STATICINLINE void DrawArraysInstancedBaseInstance(Prim p,PrimCre c,int32 vf,
     ...
     */
    STATICINLINE void DrawElementsIndirect(Prim p,PrimCre c,
                                     TypeEnum d,
                                     uint64 off)
     ...
     */
    STATICINLINE void DrawXF(Prim p,PrimCre c,CGhnd h)
     ...
     */
    STATICINLINE void DrawXFStream(Prim p,PrimCre c,CGhnd h,uint32 s)
     ...
     */
    STATICINLINE void DrawXFInstanced(Prim p,PrimCre c,CGhnd h,uint32 ic)
     ...
     * \param ic Instance count
     */
    STATICINLINE void DrawXFStreamInstanced(Prim p,PrimCre c,CGhnd h,uint32 s,uint32 ic)
