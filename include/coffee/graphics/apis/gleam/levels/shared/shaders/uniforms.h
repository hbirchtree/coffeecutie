...
struct CGL_Old_Uniforms
{
    ...
    STATICINLINE void Uniformfv(
        int32 l, int32 c, bool t, const _cbasic_tmatrix<scalar, 2>* d)
    {
        glUniformMatrix2fv(l, c, (t) ? GL_TRUE : GL_FALSE, (scalar*)d);
    }

    STATICINLINE void Uniformfv(
        int32 l, int32 c, bool t, const _cbasic_tmatrix<scalar, 3>* d)
    {
        glUniformMatrix3fv(l, c, (t) ? GL_TRUE : GL_FALSE, (scalar*)d);
    }

    STATICINLINE void Uniformfv(
        int32 l, int32 c, bool t, const _cbasic_tmatrix<scalar, 4>* d)
    {
    ...
    STATICINLINE void Uniformfv(
        int32 l, int32 c, bool t, const _cbasic_tmnmatrix<scalar, 2, 4>* d)
    {
        glUniformMatrix2x4fv(l, c, (t) ? GL_TRUE : GL_FALSE, (scalar*)d);
    }

    STATICINLINE void Uniformfv(
        int32 l, int32 c, bool t, const _cbasic_tmnmatrix<scalar, 3, 2>* d)
    {
        glUniformMatrix3x2fv(l, c, (t) ? GL_TRUE : GL_FALSE, (scalar*)d);
    }

    STATICINLINE void Uniformfv(
        int32 l, int32 c, bool t, const _cbasic_tmnmatrix<scalar, 3, 4>* d)
    {
        glUniformMatrix3x4fv(l, c, (t) ? GL_TRUE : GL_FALSE, (scalar*)d);
    }

    STATICINLINE void Uniformfv(
        int32 l, int32 c, bool t, const _cbasic_tmnmatrix<scalar, 4, 2>* d)
    {
        glUniformMatrix4x2fv(l, c, (t) ? GL_TRUE : GL_FALSE, (scalar*)d);
    }

    STATICINLINE void Uniformfv(
        int32 l, int32 c, bool t, const _cbasic_tmnmatrix<scalar, 4, 3>* d)
    {
    ...
    STATICINLINE void Uniformuiv(
        int32 l, int32 c, const _cbasic_vec2<uint32>* d)
    {
        glUniform2uiv(l, c, (uint32*)d);
    }
    STATICINLINE void Uniformuiv(
        int32 l, int32 c, const _cbasic_vec3<uint32>* d)
    {
        glUniform3uiv(l, c, (uint32*)d);
    }
    STATICINLINE void Uniformuiv(
        int32 l, int32 c, const _cbasic_vec4<uint32>* d)
    {
