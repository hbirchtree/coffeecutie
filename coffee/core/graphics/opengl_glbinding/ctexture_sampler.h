 ...
 * \param sampler
 */
extern void coffee_graphics_alloc(CTextureSampler* sampler);
/*!
 * \brief Free texture sampler
 * \param sampler
 */
extern void coffee_graphics_free(CTextureSampler* sampler);
/*!
...
extern void coffee_graphics_tex_unload(CTextureSampler const& tex, CTexture const&);

extern void coffee_graphics_tex_load_safe(
        CTextureSampler const& sampler, CTexture const& tex);

extern void coffee_graphics_tex_unload_safe(CTextureSampler const&, CTexture const&);
