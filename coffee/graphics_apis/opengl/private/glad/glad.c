/*
    ...
    OpenGL loader generated by glad 0.1.9a3 on Sat Dec 19 02:05:54 2015.
    ...
    Profile: core
    Extensions:
        GL_ARB_bindless_texture, GL_ARB_debug_output, GL_KHR_debug
    Loader: No

    Commandline:
        --profile="core" --api="gl=4.5" --generator="c" --spec="gl" --no-loader --extensions="GL_ARB_bindless_texture,GL_ARB_debug_output,GL_KHR_debug"
    Online:
        http://glad.dav1d.de/#profile=core&language=c&specification=gl&api=gl%3D4.5&extensions=GL_ARB_bindless_texture&extensions=GL_ARB_debug_output&extensions=GL_KHR_debug
*/
