...
vcpkg_cmake_configure(
    ...
    OPTIONS
        ...
        -DSDL_LIBC=ON
        # Subsystems coffeecutie does not use: audio goes through OpenAL
        # and rendering through its own RHI. Joystick and hidapi stay on
        # for gamepad support.
        -DSDL_AUDIO=OFF
        -DSDL_RENDER=OFF
        -DSDL_GPU=OFF
        ...
        -DSDL_DIALOG=OFF
        -DSDL_TRAY=OFF
        # Headless capture depends on this one
        -DSDL_OFFSCREEN=ON
