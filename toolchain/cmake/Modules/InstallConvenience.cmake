macro(COFFEE_BUNDLE)
  cmake_parse_arguments(
    BUN "FORCE" "DESTINATION" "HEADER_DIRECTORIES;PUBLIC_HEADERS;LIBRARIES"
    ${ARGN}
  )
  ...
  foreach(INC ${BUN_HEADER_DIRECTORIES})
    ...
    if("${INC}" MATCHES ".*/include[\/]?$")
      install(DIRECTORY ${INC} DESTINATION ${BUN_DESTINATION})
    else()
      if(NOT BUN_FORCE)
        install(
          DIRECTORY ${INC}
        ...
        install(DIRECTORY ${INC} DESTINATION ${BUN_DESTINATION}/include/)
      endif()
    endif()
  endforeach()

  install(FILES ${BUN_PUBLIC_HEADERS} DESTINATION ${BUN_DESTINATION}/include)
