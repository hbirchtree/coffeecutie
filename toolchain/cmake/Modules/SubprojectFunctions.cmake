...
if(CMAKE_CXX_COMPILER_ID STREQUAL "GNU" AND CMAKE_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL 16)
    set(COFFEE_CPP_REFLECTION_AVAILABLE TRUE)
else()
    set(COFFEE_CPP_REFLECTION_AVAILABLE FALSE)
endif()
...
macro(INIT_SUBPROJECT)
  ...
  set(COFFEE_DESKTOP_DIRECTORY "${CMAKE_SOURCE_DIR}/toolchain/desktop")
...
function(ADD_GITPROJECT_INTERNAL NAME SOURCE)
  cmake_parse_arguments(GITP "" "TAG" "" ${ARGN})
...
macro(ADD_GITPROJECT NAME)
  add_gitproject_internal(${NAME} ${ARGN})
